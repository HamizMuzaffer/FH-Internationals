...
export function SignupDrawer({ isOpen, toggleDrawer }: DrawerDemoProps) {
  return (
    <Drawer open={isOpen} onOpenChange={toggleDrawer}>
      <DrawerContent className="flex flex-col h-[90vh] max-h-screen"> {/* Set max height */}
        <DrawerClose asChild>
        ...
        <div className="flex-grow overflow-y-auto p-4"> {/* Main content area */}
          ...
          <div className=""> {/* Allow scrolling for the form */}
            <RegistrationForm  />
          </div>
